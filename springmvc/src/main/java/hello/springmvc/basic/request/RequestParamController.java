...
public class RequestParamController {
    ...
    public String requestParamV5(@RequestParam String username, @RequestParam(required = false) Integer age) {
        log.info("memberName = {}, memberAge = {}", username, age);
        return "OK";
    }
    ...
    public String requestParamV5(@RequestParam Map<String, Object> paramMap) {
    ...
    public String modelAttributeV1(@ModelAttribute HelloData helloData) {
        log.info("memberName = {}, memberAge = {}", helloData.getUsername(), helloData.getAge());
